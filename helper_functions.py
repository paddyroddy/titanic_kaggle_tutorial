...
def _get_dataframes_intersections(df1, comparator1, df2, comparator2):
    """
    ...
    """
    comparator1 = _get_intersection(df1, comparator1, comparator2)
    comparator2 = _get_intersection(df2, comparator2, comparator1)
...
def predict(test_data, results, model_name):
    ...
    """
    model_params = pd.DataFrame(results[model_name][0].params)
    ...
    xt, model_params = _get_dataframes_intersections(
    ...
    model_array = [model_parameters for parameter in range(row)]
